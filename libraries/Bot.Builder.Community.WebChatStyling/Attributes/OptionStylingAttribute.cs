...
{
    public class OptionStylingAttribute : StylingAttribute
    {
        public OptionStylingAttribute() :
            base(string.Empty, StylingAttributeCategory.Option, StylingPropertyCategory.General) 
        {
        }
    }
}
